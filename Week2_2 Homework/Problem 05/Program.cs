    ...
    class Program
    {
        static void Main()
        {
            ...
            while (run == "y")
            {
                ...
                {
                    isThrid7 = (numberString[numberString.Length-3] == '7' && numberString.Length >= 3); //проверка на симво на съответната позиция
                }
                else
                    isThrid7 = false;
                ...
                bool isThrid7_2=((numberInt%1000)/100==7); // Остатъка от деления на 1000 разделен на 100 дава стотицитите на числото
